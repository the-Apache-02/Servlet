<%-- 
    Document   : index
    Created on : 19 Jul, 2022, 8:23:00 AM
    Author     : risha
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid p-0 m-0 banner-background">
            <div class="jumbotron">
                <div class="container">
                    <h3 class="display-3">Welcome to TechAritcles</h3>
                    <p>This is the website where everyone share there knowledge about technical world.</p>
                    ...
                    <button class="btn btn-outline-light primary-background btn-lg"><span class="fa fa-external-link"></span> Start! its free</button>
                    <a href="login.jsp" class="btn btn-outline-light primary-background btn-lg"><span class="fa fa-user-o fa-spin"></span> Log In</a>
